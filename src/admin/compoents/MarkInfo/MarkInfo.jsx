import { Select,MenuItem,Paper,Table,TableCell,TableContainer,TableHead,TableRow,TableBody,Box,Button,IconButton,TableSortLabel,TextField } from '@mui/material';
...
function MarkInfo() {
    ...
    return (
        ...
        <StyledButton variant="outlined" color="inherit" onClick={handleSearch}>
        <SearchIcon />
        </StyledButton>
        </StyledBox><br></br>
        <IconButton
        ...
        {search === 1 && (
            <>
            {filteredTrademarks.slice(pagesVisited, pagesVisited + itemsPerPage).map((trademark) => (
              <TableRow className="table-row">
                <TableCell align="center">{trademark.id}</TableCell>
                <TableCell align="center">{trademark.brand_name}</TableCell>
                <TableCell align="center">{trademark.type}</TableCell>
