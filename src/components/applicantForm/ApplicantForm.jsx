    ...
    <>
      ...
      {dialogOpen && (
        ...
        >
          ...
          <DialogContent dividers>::: 개인정보처리방침 ::::<br/><br/>


특허법인 원전(이하 '회사'라 합니다.)은 회원의 사생활 및 개인정보를 적극적으로 보호하여 정보화 사회에서의 통신의 자유를 보장하고자 아래와 같이 개인정보처리방침을 명시하여 실천하고 있습니다.
<br/><br/>
...
<br/><br/>
4. 개인정보의 취급위탁<br/>
회사는 보다 나은 서비스의 제공을 위해 아래와 같은 업체에 회원의 개인정보를 취급 위탁합니다. 또한 위탁계약 시 개인정보보호의 안전을 기하기 위하여 개인정보보호 관련 법규의 준수, 개인정보에 관한 제3자 공급 금지 및 사고시의 책임부담 등을 명확히 규정하고 있습니다.<br/>
- 실명확인 : OO신용평가<br/>
- 서버의 운영 및 관리 : 심플렉스인터넷㈜<br/>
- 카드결제 : OOOO<br/><br/>

5. 자신의 개인정보 열람, 수정 및 삭제<br/>
...
7. 개인정보의 파기절차<br/>
회원님이 회원가입 등을 위해 입력하신 정보는 목적이 달성된 후 내부 방침 및 기타 관련 법령에 의한 정보보호 사유에 따라(보유 및 이용기간 참조) 일정 기간 저장된 후 파기됩니다.<br/><br/>
