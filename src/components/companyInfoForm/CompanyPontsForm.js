      ...
      <Box className={classes.infoBox02} sx={{ height: "100%" }}>
        <Grid container spacing={3}>
          <Grid className={classes.gridBox} item xs={4} md={4}>
            <img src={companyImage01} height="auto" width="500px" />
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Typography className={classes.paragraphs02}>
              풍부한 경험을 갖춘 상표전문가의 노하우와
              <br />
              선행상표 조사 시, 엄격한 심사 요건 판단
              <br />
              (사업화 중이거나 사업화 예정, 해외상표출원 예정인 상표들 위주로
              출원)
              <br />
              검토로, 중간사건(거절이유)이 발생되지 않도록 하여 높은 등록성공률
              <br />
              <br />
              <br />
            </Typography>
            ...
            <Grid item xs={12} md={12}>
              ...
              <Typography className={classes.paragraphs02}>
                빠른상표출원으로 통상 15개월 넘는 심사기간을 3개월로
                <br />
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={6}>
            ...
            <Typography className={classes.paragraphs03}>
              대리인 수수료(선행상표조사+우선심사포함) 할인된 20만원!
              <br />
              특허청 전문기관과 계약 우선심사조사료 절감
              <br />
            </Typography>
            ...
            <Grid item xs={12} md={12}>
              ...
              <Typography className={classes.paragraphs03}>
                해외상표출원은 국내대리인 수수료 대폭 할인하여 초저가로
                <br />
                진행 경험이 풍부한 해외대리인들을 활용 초저가
                <br />
                (출원비용 절감+중간사건 횟수 단축)
              </Typography>
            </Grid>
          ...
          <Grid className={classes.gridBox02} item xs={4} md={4}>
            <img src={companyImage02} height="400px" width="580px" />
          </Grid>
        </Grid>
      </Box>
    </div>
