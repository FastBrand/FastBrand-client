        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={12}>
            <Typography className={classes.paragraphs} variant="body1">
              ...
              <br />
              특허, 실용신안, 디자인, 상표, 저작권, 컴퓨터프로그램, 반도체
              배치설계, 라이센싱 등의 출원, 등록, 심판 및 침해소송 등<br />
              국내외 고객 여러분의 지적재산권 전반에 관한 업무를 대리하고
              있습니다.
              <br />
              <br />
              한편, 저희들 원전은 특허청과의 유기적인 업무협력체제를 유지하고
              기동성 있는 업무를 수행하고 있으며,
              <br />
              기계, 금속, 재료, 전기, 전자, 반도체, 통신, 비즈니스 모델, 물리,
              화학, 생명공학, 약학, 상표, 디자인 등의
              <br />
              출원, 등록, 심판, 소송 등 전분야에 걸친 업무를 대리하는 국제적인
              특허법인으로서 오늘에 이르기까지
              <br />
              등록, 심판, 소송 등 최상의 성공률을 견지해 오고 있습니다. 또한,
              원전은 세계주요국가의 특허사무소와 긴밀히 유대하여
              <br />
